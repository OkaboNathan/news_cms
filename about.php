...
<div class="row">
  ...
  <div class="column">
    <div class="card">
      <img src="img/2.avif" alt="Mike" style="width:100%">
      <div class="container">
        <h2>Nsubuga Johnson</h2>
        <p class="title">Art Director</p>
        <p>With Experience of over five years</p>
        <p>nsubuga@gmail.com</p>
        <p><button class="button">Contact</button></p>
      </div>
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="img/3.webp" alt="John" style="width:100%">
      <div class="container">
        <h2>John Doe</h2>
        <p class="title">Designer</p>
        <p>Content creater with over 10 years of Experience</p>
        <p>john@gmail.com</p>
        <p><button class="button">Contact</button></p>
      </div>
    </div>
